...
<div className="h-screen overflow-y-auto bg-[#121212] text-white ">
    ...
    <nav className="mx-auto flex max-w-7xl items-center py-2">
      ...
      <div
        ...
        <div className="mb-8 mt-auto flex w-full flex-wrap gap-4 px-4 sm:mb-0 sm:mt-0 sm:items-center sm:px-0">
          <button className="w-full bg-[#383737] px-3 py-2 hover:bg-[#4f4e4e] sm:w-auto sm:bg-transparent">{username}</button>
          <button
  ...
  <div className="flex min-h-[calc(100vh-66px)] sm:min-h-[calc(100vh-82px)]">
    <aside
      className="group fixed inset-x-0 bottom-0 z-40 w-full shrink-0 border-t border-white bg-[#121212] px-2 py-2 sm:absolute sm:inset-y-0 sm:max-w-17.5 sm:border-r sm:border-t-0 sm:py-6 sm:hover:max-w-62.5 lg:sticky lg:max-w-62.5">
